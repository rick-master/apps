...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewCoursesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivity.this,PizzaDetails.class);
                startActivity(i);
            }
        });
    ...
    private void addDataToFirestore(String courseName, String courseDescription, String courseDuration) {
        ...
        CollectionReference dbCourses = db.collection("Pizzas");

        // adding our data to our courses object class.
        Pizzas courses = new Pizzas(courseName, courseDescription, courseDuration);
        ...
        dbCourses.add(courses).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                ...
                Toast.makeText(MainActivity.this, "Your Pizza has been added to Firebase Firestore", Toast.LENGTH_SHORT).show();
            }
